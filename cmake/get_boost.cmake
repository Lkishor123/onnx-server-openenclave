...
macro(DOWNLOAD_BOOST)
  ...
  ExternalProject_Add(
      BoostBuild
      URL https://sourceforge.net/projects/boost/files/boost/${BOOST_REQUESTED_VERSION}/boost_${BOOST_REQUESTED_VERSION_UNDERSCORE}.tar.bz2
  ...
  # Set include folders
  ExternalProject_Get_Property(BoostBuild INSTALL_DIR)
  ...
  add_dependencies(Boost BoostBuild)
